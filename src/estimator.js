...
const covid19ImpactEstimator = (data) => {
  ...
  return {
    ...
    impact: {
      ...
      dollarsInFlight: (Math.trunc((cofactor * rfactor * (data.avgDailyIncomeInUSD) * (data.avgDailyIncomePopulation)) / days))
    },
    severeImpact: {
      ...
      dollarsInFlight: (Math.trunc((cisfactor * rfactor * (data.avgDailyIncomeInUSD) * (data.avgDailyIncomePopulation)) / days))
    }
  };
};
